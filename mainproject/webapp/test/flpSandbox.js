		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexusmainproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusmainproject-display": {
								"semanticObject": "comapplexusmainproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.mainproject",
									"url": sap.ui.require.toUrl("com/applexus/mainproject")
								}
							}
						}
					}
