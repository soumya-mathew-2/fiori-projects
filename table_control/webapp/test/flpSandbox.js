		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table control",
									"targetURL": "#comapplexustablecontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexustablecontrol-display": {
								"semanticObject": "comapplexustablecontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.tablecontrol",
									"url": sap.ui.require.toUrl("com/applexus/tablecontrol")
								}
							}
						}
					}
