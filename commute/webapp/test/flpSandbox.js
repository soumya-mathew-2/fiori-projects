		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexuscommute-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuscommute-display": {
								"semanticObject": "comapplexuscommute",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.commute",
									"url": sap.ui.require.toUrl("com/applexus/commute")
								}
							}
						}
					}
