sap.ui.define([
    ...
    function (Controller, formatter, MessageToast, MessageBox) {
        ...
        return Controller.extend("com.applexus.commute.controller.Seeker", {
            ...
            onBookTrip: function (oEvent) {
                ...
                oBusyDialogs.open();
                oBookingsModel.create("/BookingSet", oBooking, {
                    success: function () {
                        oBusyDialogs.close();
            ...
            onCancel: function (oBooking) {
                ...
                oModel.update("/BookingSet(BookingId='" + onCancelPayload.BookingId + "')", onCancelPayload, {
                    success: function () {
                        oBusyDialog.close();
                        this.onViewBookings();
                    }.bind(this),
            ...
            onFeedback: function (oEvent) {
               ...
               return;
                ...
                oFeedbackModel.update("/BookingSet(BookingId='" + oFeedBackPayload.BookingId + "')", oFeedBackPayload, {
                    success: function () {
                        oBusyDialog.close();
                        this.onViewBookings();
                    }.bind(this),
