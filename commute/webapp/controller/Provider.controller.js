sap.ui.define([
    ...
    function (Controller, Fragment, NumberFormat, MessageToast, formatter, MessageBox) {
        "use strict";
        var oStop = 0, check = 0;
        return Controller.extend("com.applexus.commute.controller.Provider", {
            ...
            onProviderSelect: function (oEvent) {
                ...
                if (key === 'my_trips') {
                    ...
                    oBusyDialogL.open();
                    oPointsModel.read("/UserSet(UserId='" + this.pId + "',UserRole='P')", {
            ...
            onAddTrip: function () {
                ...
                oBusyDialog.open();
                oTripModel.create("/TripSet", oAddtrip, {
                    success: function (oResponse) {
                        oBusyDialog.close();
            ...
            onTripIdPress: function (oEvent) {
                ...
                oBusyDialogT.open();
                oTripDetailsModel.read("/TripSet(TripId='" + tripId + "')", {
                    success: function (oResponse) {
                        debugger;
                        ...
                        if (!that.oDialog) {
                            Fragment.load({
                                id: "trip_details",
                                name: "com.applexus.commute.fragment.tripdetails",
                                controller: that
            ...
            onCancel: function (oTrips) {
                ...
                oModel.update("/TripSet(TripId='" + blockPayload.TripId + "')", blockPayload, {
                    success: function () {
                        oBusyDialogb.close();
                        this.onReadTrips();
                    }.bind(this),
            ...
            editTrip: function (oTrip) {
                ...
                if (!this.editDialog) {
                    Fragment.load({
                        id: "edit_trip",
                        name: "com.applexus.commute.fragment.edittrip",
                        controller: this
            ...
            onSaveEditedTrip: function () {
                ...
                oTripEditModel.update("/TripSet(TripId='" + oTripEditedData.TripId + "')", oTripEditedData, {
                    success: function () {
            ...
            handleValueHelp: function (oEvent) {
                ...
                if (!this.oValueHelpDialog) {
                    this.oValueHelpDialog = Fragment.load({
                        id: "vehicle",
                        name: "com.applexus.commute.fragment.vehicleselectdialog",
                        controller: this
