sap.ui.define([
    ...
    function (Controller,MessageToast, MessageBox) {
        ...
        return Controller.extend("com.applexus.commute.controller.Registration", {
            onInit: function () {
                this.router = this.getOwnerComponent().getRouter();
                this.router.getRoute("RouteReg").attachPatternMatched(this.getId,this);
            ...
            onRegister: function() {
                ...
                if (!namePattern.test(fName) ) {
                    ...
                    MessageToast.show("Invalid first name, enter atleast 2 characters");
                    return; 
                } else {
                ...
                if (!namePattern.test(lName) ) {
                    ...
                    MessageToast.show("Invalid last name, enter atleast 2 characters");
                    return; 
                } else {
                ...
                oBusyDialog.open();
                debugger;
                oDataModel.create("/UserSet", oRegister, {
                    success: function(oResponse){
                        oBusyDialog.close();
