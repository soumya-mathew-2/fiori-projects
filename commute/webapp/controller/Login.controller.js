sap.ui.define([
    ...
    function (Controller, Fragment, MessageToast, MessageBox) {
        ...
        var router;
        var userRole;
        return Controller.extend("com.applexus.commute.controller.Login", {
            onInit: function () {
            ...
            onLogin: function () {
                ...
                oBusyDialog.open();
                oDataModel.read("/UserSet(UserId='" + userId + "',Password='" + passwd + "')", {
                    success: function (oResponse) {
                        ...
                        if (oResponse.UserRole === "A") {
                            ...
                            if (!that.oDialog) {
                                Fragment.load({
                                    id: "role",
                                    name: "com.applexus.commute.fragment.selectrole",
                                    controller: that
            ...
            onProviderSelect: function () {
                ...
                oBusyDialogL.open();
                oPointsModel.read("/UserSet(UserId='" + userId + "',UserRole='P')", {
            ...
            onSeekerSelect: function () {
                ...
                oBusyDialogL.open();
                oPointsModel.read("/UserSet(UserId='" + userId + "',UserRole='S')", {
                    success: function (oPoints) {
                        debugger;
            ...
            checkLicenseDetails: function () {
                ...
                oBusyDialogL.open();
                oLicenseModel.read("/UserSet(UserId='" + userId + "')", {
                    success: function (oLicense) {
                        ...
                        if (oLicense.LicenceNumber == '' || oLicense.LicenceValididty == '') {
                            if (!that1.oDialogL) {
                                Fragment.load({
                                    id: "no_lic",
                                    name: "com.applexus.commute.fragment.nolicence",
                                    controller: that1
            ...
            onAddLicence: function () {
                if (!this.oDialogLA) {
                    Fragment.load({
                        id: "add_lic",
                        name: "com.applexus.commute.fragment.addlicence",
                        controller: this
            ...
            onSaveLicence: function () {
                ...
                oLicenseModels.update("/UserSet(UserId='" + userId + "')", licencePayload, {
                    success: function () {
                        oBusyDialogLU.close();
                        that.getView().byId("userid").setValue("");
                        that.getView().byId("password").setValue("");
