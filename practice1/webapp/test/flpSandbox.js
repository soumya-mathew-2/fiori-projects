		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexuspractice1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuspractice1-display": {
								"semanticObject": "comapplexuspractice1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.practice1",
									"url": sap.ui.require.toUrl("com/applexus/practice1")
								}
							}
						}
					}
