		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Model",
									"targetURL": "#comapplexusmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusmodel-display": {
								"semanticObject": "comapplexusmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.model",
									"url": sap.ui.require.toUrl("com/applexus/model")
								}
							}
						}
					}
